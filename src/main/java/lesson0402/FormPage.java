...
import static lesson0402.Massengers.VIBER;
...
public class FormPage {
    ...
    @FindBy(xpath = "//*[@id=\"field-messenger-consultation\"]/div/div/div/div[2]/button[1]")
    WebElement messengerTg;
...
//            }else{
 ...
 @Step("Create consultation query userName: {user} messenger: {messengers} courseName: {courseNames}")
